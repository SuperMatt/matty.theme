...
<div class="row">
    <div class="col-xs-12 post-commentnumber">
        <a class="commentnumber" href="<?php echo get_permalink(); ?>#disqus_thread" data-disqus-identifier="<?php echo get_post_meta(get_the_ID(), 'dsq_thread_id', true); ?>">Comments</a>
    </div>
</div>
<?php endif; ?>
